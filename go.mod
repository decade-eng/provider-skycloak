module github.com/decade-eng/provider-skycloak
...
require (
	...
	github.com/sky-cloak/terraform-provider-skycloak v0.0.0-local
...
replace github.com/sky-cloak/terraform-provider-skycloak => ./third_party/terraform-provider-skycloak
